...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,n,i){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(n),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},E={animation:!0,autohide:!0,delay:5e3};class x extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return E}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const n=e.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=x.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return i.enableDismissTrigger(x),e.defineJQueryPlugin(x),x}(r(),c(),w(),A())}(Qt);var Yt,Kt,Xt,Ut,Jt,Gt,Zt,en,tn,nn,sn,on=Qt.exports;Yt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Kt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Yt||Kt||Xt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),Jt=document.documentElement,Gt=window,Zt=Gt.scrollY||Jt.scrollTop,en=0,tn=0,nn=document.getElementById("wrapper-navbar"),sn=function(e,t){2===e&&t>125?document.getElementById("navbar").classList.contains("show")||(nn.classList.add("hide"),tn=e):1===e&&(nn.classList.remove("hide"),tn=e)},window.addEventListener("scroll",(function(){(Ut=Gt.scrollY||Jt.scrollTop)>Zt?en=2:Ut<Zt&&(en=1),en!==tn&&sn(en,Ut),Zt=Ut})),document.addEventListener("scroll",(function(){var e=document.getElementById("navbar");document.getElementById("primaryNav").classList.contains("show")||e.classList.toggle("scrolled",window.scrollY>e.offsetHeight),document.querySelectorAll(".dropdown-menu").forEach((function(e){e.classList.remove("show")})),document.querySelectorAll(".dropdown-toggle").forEach((function(e){e.classList.remove("show"),e.blur()}))})),document.getElementById("navToggle").addEventListener("click",(function(){document.getElementById("navbar").classList.toggle("navdark")})),document.body.addEventListener("click",(function(e){if(!e.target.closest(".navbar")){var t=document.querySelector(".navbar .navbar-collapse");if(t){var n=bootstrap.Collapse.getInstance(t);n&&n.hide()}}})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=Rt,e.Scrollspy=zt,e.Tab=Vt,e.Toast=on,e.Tooltip=Bt}));
